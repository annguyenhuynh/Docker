...
# Ritual Roast Coffee - Mini Project
## ECR - ECS on EC2
## IAAS Academy YouTube Channel
![alt text](image.png)

### Step 1: Set up VPC

### Step 2: Create repo in ECR

### Step 3: Build the docker image 
    
    * Ensure Docker Deamon is installed: **sudo systemctl start docker**
    * Check docker status: **sudo systemctl status docker**
    * Add EC2 user name to Docker: **sydo usermod -aG docker ec2-user**
    * Exit
    * SSH into EC2 instance again
    * **docker ps** --> No error returned --> Docker configured and run properly
    * Build docker image from Dockerfile: ** doccker build -t <ECR URI> .**

### Step 4: Push Docker image to ECR
    * Click on the ECR image and select **View Push Command**
    * Because we have built the image in step 3, we will move directly to oush step

### Step 5: Create Database
    * In this use case, we created RDS instance with MySQL engine

### Step 6: Create AWS Secrets Manager
    * This is used to securely store RDS credentials

### Step 7: Create Target Group for ALB
    * Create Target Group for ALB

### Step 8: Create ALB

### Step 9: Create an ECS task role
    * Have ECS Task Service Role
    * Have access to spefic Secrets Manager ARN created in step 6
